...
```{r}
## Interaction between Temp and Species
  all.CF.m1 <- lm(all.data$CF~all.data$Bucket*all.data$Species_Seq)
  summary(all.CF.m1)
  Anova(all.CF.m1, type = 2)
  drop1(all.m1)
  
  all.CF.m2 <- lm(all.data$CF~all.data$Bucket+all.data$Species_Seq)
  summary(all.CF.m2)
  Anova(all.CF.m2, type = 2)
  drop1(all.m2)
  
  all.CF.m3 <- lm(all.data$CF~all.data$Bucket)
  summary(all.CF.m3)
  Anova(all.CF.m3, type = 2)
  drop1(all.m3)
